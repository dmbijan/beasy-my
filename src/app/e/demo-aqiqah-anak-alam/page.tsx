...
export default function EventPortalPage() {
  ...
  const eventData = {
    title: "Majlis Aqiqah Anak Alam",
    eventType: "aqiqah",
    eventDate: new Date("2025-10-20T11:00:00"),
    venueName: "Rumah Aiman",
    venueAddress: "Jalan Seri Kembangan, 43300 Seri Kembangan",
    mapsLink: "https://maps.google.com/?q=Seri+Kembangan",
    modules: {
    ...
    angpao: {
      type: "both", accountNumber: "8888-9999-0000", bankName: "Bank Rakyat",
      accountName: "Aiman bin Ahmad", duitnowNumber: "016-8889990",
  ...
  return (
    <div className="min-h-screen mesh-gradient pb-32">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="relative px-4 pt-8 pb-6">
        ...
        {eventSlug === 'demo-aqiqah-anak-alam' && (
              ...
              {eventData.modules.menu && (
                <GlassCard variant="light" glow="amber">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div><h3 className="font-semibold text-white">Senarai Menu</h3><p className="text-sm text-white/60">Hidangan aqiqah</p></div>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    {["Nasi Lemak", "Kari Kambing", "Roti Canai", "Teh Tarik"].map((menu) => (
              ...
              {eventData.modules.angpao && (
                <GlassCard variant="light" glow="emerald">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div><h3 className="font-semibold text-white">Digital Angpao</h3><p className="text-sm text-white/60">Sumbangan untuk anak</p></div>
                  </div>
