...
import { MapPin, Calendar, Utensils, Camera, Mic, Heart, QrCode, Users, CreditCard, Sparkles, HomeIcon, PartyPopper as Party, Download, Navigation } from "lucide-react"
...
export default function EventPortalPage() {
  ...
  const eventData = {
    title: "Majlis Pesta Tahunan Beasy.my",
    eventType: "party",
    eventDate: new Date("2025-12-31T20:00:00"),
    venueName: "The Roof Top Bar",
    venueAddress: "Bukit Bintang, 55100 Kuala Lumpur",
    ...
    modules: {
      ...
      songRequest: false, liveWall: true, angpao: true,
    },
    angpao: {
      type: "both", accountNumber: "9999-8888-7777", bankName: "CIMB Bank",
      accountName: "Beasy.my Sdn Bhd", duitnowNumber: "1-800-BEASY-MY",
      duitnowName: "Beasy.my", qrImageUrl: "/duitnow-qr-sample.svg",
    },
  }
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="relative px-4 pt-8 pb-6">
        <GlassCard variant="light" className="mb-6">
          <div className="text-center">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-500/20 border border-purple-500/30 text-xs font-medium text-purple-300 mb-3">
              <Party className="w-3 h-3" /> Party
            </span>
              ...
              {eventData.modules.menu && (
                <GlassCard variant="light" glow="amber">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div><h3 className="font-semibold text-white">Senarai Menu</h3><p className="text-sm text-white/60">Hidangan party</p></div>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    {["Canapé", "Wings", "Pizza Bites", "Cocktail"].map((menu) => (
              ...
              {eventData.modules.angpao && (
                <GlassCard variant="light" glow="emerald">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div><h3 className="font-semibold text-white">Digital Angpao</h3><p className="text-sm text-white/60">Sumbangan untuk majlis</p></div>
                  </div>
              ...
              {eventData.modules.liveWall && (
                <GlassCard variant="light" glow="indigo">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {["Razak", "Aisha", "Danial", "Zara", "Imran", "Layla"].map((name) => (
