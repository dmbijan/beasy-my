...
export default function EventPortalPage() {
  ...
  const eventData = {
    ...
    venueName: "Restoran Nasi Kandar Ali",
    venueAddress: "Jalan Bukit Bintang, 55100 Kuala Lumpur",
    mapsLink: "https://maps.google.com/?q=Nasi+Kandar+Bukit+Bintang",
    modules: {
      rsvp: true,
      seating: true,
      menu: true,
    ...
    angpao: {
      ...
      bankName: "Maybank",
      accountName: "Ali bin Ahmad",
      duitnowNumber: "019-8765432",
      duitnowName: "Ali bin Ahmad",
  ...
  const dockItems = [
    ...
    { icon: <Mic className="w-5 h-5" />, label: "Audio", onClick: () => setActiveModule("audioguestbook"), active: activeModule === "audioguestbook" },
  ]
      ...
      >
        <GlassCard variant="light" className="mb-6">
          <div className="text-center">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/20 border border-amber-500/30 text-xs font-medium text-amber-300 mb-3">
              ...
              {eventData.modules.menu && (
                <GlassCard variant="light" glow="amber">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["Nasi Kandar", "Roti Canai", "Mee Goreng", "Teh Tarik"].map((menu) => (
                  ...
                  {angpaoView === "qr" && (
                    ...
                    >
                      <div className="w-48 h-48 rounded-2xl bg-white flex items-center justify-center p-3 shadow-lg">
                        {qrImage ? (
                          <img src={qrImage} alt="QR DuitNow" className="w-full h-full object-contain" />
                        ) : (
                          <div className="text-center">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-sm font-medium text-white">{eventData.angpao.duitnowNumber}</p>
