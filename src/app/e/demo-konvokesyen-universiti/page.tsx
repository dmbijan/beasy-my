...
import { 
  MapPin, Calendar, Utensils, Camera, Mic, Heart, Music, QrCode, Users, CreditCard, Sparkles, HomeIcon, GraduationCap,
  Download, Navigation
} from "lucide-react"
...
export default function EventPortalPage() {
  ...
  const eventData = {
    title: "Konvokesyen Universiti",
    eventType: "graduation",
    eventDate: new Date("2026-02-15T10:00:00"),
    venueName: "Audiotorium Utama, Universiti Malaya",
    venueAddress: "50603 Kuala Lumpur",
    mapsLink: "https://maps.google.com/?q=UM+Main+Auditorium",
    modules: {
    ...
    angpao: {
      type: "both", accountNumber: "5555-6666-7777", bankName: "Public Bank",
      accountName: "Ali bin Ahmad", duitnowNumber: "013-5556667",
      duitnowName: "Ali bin Ahmad", qrImageUrl: "/duitnow-qr-sample.svg",
    },
  }
  ...
  return (
    <div className="min-h-screen mesh-gradient pb-32">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="relative px-4 pt-8 pb-6">
        ...
        {eventSlug === 'demo-konvokesyen-universiti' && (
              ...
              {eventData.modules.menu && (
                <GlassCard variant="light" glow="amber">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div><h3 className="font-semibold text-white">Senarai Menu</h3><p className="text-sm text-white/60">Buffet konvokesyen</p></div>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    {["Nasi Lemak Buffet", "Ayam Goreng", "Sayur Lodeh", "Kuih-Muih"].map((menu) => (
