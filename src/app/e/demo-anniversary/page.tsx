...
import { MapPin, Calendar, Utensils, Camera, Heart, Sparkles, HomeIcon, Gift, Users, Download, Navigation } from "lucide-react"
...
export default function EventPortalPage() {
  ...
  const eventData = {
    title: "Perayaan Ulang Tahun Perkahwinan ke-25",
    eventType: "anniversary",
    eventDate: new Date("2025-12-15T19:00:00"),
    venueName: "Grand Ballroom KLCC",
    venueAddress: "Kuala Lumpur City Centre, 50088 Kuala Lumpur",
    ...
    modules: {
      ...
      songRequest: false, liveWall: true, angpao: false,
    },
    angpao: {
      type: "both", accountNumber: "5555-6666-7777", bankName: "Maybank",
      accountName: "Ahmad & Fatimah", duitnowNumber: "012-5556667",
      duitnowName: "Ahmad & Fatimah", qrImageUrl: "/duitnow-qr-sample.svg",
    },
  }
  ...
  const dockItems = [
    ...
    { icon: <Heart className="w-5 h-5" />, label: "Wishes", onClick: () => setActiveModule("wishes"), active: activeModule === "wishes" },
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="relative px-4 pt-8 pb-6">
        <GlassCard variant="light" className="mb-6">
          <div className="text-center">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-pink-500/20 border border-pink-500/30 text-xs font-medium text-pink-300 mb-3">
              <Gift className="w-3 h-3" /> Anniversary
            </span>
              ...
              {eventData.modules.menu && (
                <GlassCard variant="light" glow="amber">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div><h3 className="font-semibold text-white">Senarai Menu</h3><p className="text-sm text-white/60">Hidangan anniversary</p></div>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    {["Roast Beef", "Salmon", "Caesar Salad", "Crème Brûlée"].map((menu) => (
              ...
              {eventData.modules.liveWall && (
                <GlassCard variant="light" glow="emerald">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {["Zain", "Mira", "Farid", "Amina", "Hakim", "Nadia"].map((name) => (
