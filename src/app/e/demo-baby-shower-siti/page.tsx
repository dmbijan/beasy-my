...
import { MapPin, Calendar, Utensils, Camera, Mic, Heart, QrCode, Users, CreditCard, Sparkles, HomeIcon, Baby, Download, Navigation } from "lucide-react"
...
export default function EventPortalPage() {
  ...
  const eventData = {
    title: "Baby Shower Siti",
    eventType: "baby",
    eventDate: new Date("2025-11-01T14:00:00"),
    venueName: "Rumah Siti",
    venueAddress: "Jalan Ampang, 50450 Kuala Lumpur",
    mapsLink: "https://maps.google.com/?q=Ampang",
    modules: {
    ...
    angpao: {
      type: "both", accountNumber: "2222-3333-4444", bankName: "RHB Bank",
      accountName: "Siti Nurhaliza", duitnowNumber: "017-2223334",
      duitnowName: "Siti Nurhaliza", qrImageUrl: "/duitnow-qr-sample.svg",
    },
  }
  ...
  return (
    <div className="min-h-screen mesh-gradient pb-32">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="relative px-4 pt-8 pb-6">
        <GlassCard variant="light" className="mb-6">
          <div className="text-center">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-pink-500/20 border border-pink-500/30 text-xs font-medium text-pink-300 mb-3">
              <Baby className="w-3 h-3" /> Baby Shower
            </span>
        ...
        {eventSlug === 'demo-baby-shower-siti' && (
              ...
              {eventData.modules.menu && (
                <GlassCard variant="light" glow="amber">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div><h3 className="font-semibold text-white">Senarai Menu</h3><p className="text-sm text-white/60">Hidangan baby shower</p></div>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    {["Kek Baby Shower", "Fruit Punch", "Mini Sandwich", "Cupcakes"].map((menu) => (
              ...
              {eventData.modules.angpao && (
                <GlassCard variant="light" glow="emerald">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div><h3 className="font-semibold text-white">Digital Angpao</h3><p className="text-sm text-white/60">Sumbangan untuk bayi</p></div>
                  </div>
